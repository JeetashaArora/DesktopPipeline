...
import TransactionDisplay from './pages/transaction/TransactionDisplay'
        ...
        <BrowserRouter>
          ...
          <div className="container">
            ...
            <Routes>
              ...
              />
              <Route
                path="/transaction" element={user ? <TransactionDisplay/> : <Navigate to="/login" />}
              />
              <Route
                path="/todolist" element={user ? <TodoList/> : <Navigate to="/login" />}
              />
              <Route
                path="/chat" element={user ? <Chatbot/> : <Navigate to="/login" />}
              />
